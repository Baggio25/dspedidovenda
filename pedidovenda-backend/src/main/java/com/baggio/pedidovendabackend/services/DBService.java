...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "João da Silva", "joaoteste@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, encoder.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Rodrigo Baggio", "rodrigobaggio.precisa@gmail.com", "08125291970",
				TipoCliente.PESSOAFISICA, encoder.encode("123456"));
		cli2.getTelefones().addAll(Arrays.asList("46999758773"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 300", "Jardim America", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Teste", "105", "Sala 800", "Centro", "38777012", cli2, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("31/08/2021 10:30"), cli1, e2);

		Pagamento pgto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pgto1);

		Pagamento pgto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("31/08/2021 00:00"),
				null);
